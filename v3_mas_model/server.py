...
model_params = {
    ...
    "verified": UserSettableParameter("checkbox", "Verified accounts included", False),

    "location": UserSettableParameter("checkbox", "Location", False),

    "most_frequent_users": UserSettableParameter("checkbox", "Most frequent users", False),
...
server = ModularServer(
    SocialNetwork, [chart3, chart2], "Tweet Topic Model - Version 3", model_params
)
server.port = 8521
